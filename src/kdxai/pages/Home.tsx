  ...
  const currentProducts = [
    {
      ...
      users: "MVP Phase",
      link: "https://xmprep-neet.lovable.app/ai-tutor-demo"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://xmprep-neet.lovable.app/ai-tutor-demo" target="_blank" rel="noopener noreferrer">
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              {verticals.map((vertical, index) => (
                <article key={index} className="mb-20">
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 mb-6 text-center">
                      <p className="text-blue-800 font-medium">
                        💡 These are ideas we're exploring for the future, building on our proven RAG foundation
                      </p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {vertical.plannedProducts.map((product, productIndex) => (
                        <Card key={productIndex} className="border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white border-l-4 border-l-blue-500">
                          <CardHeader className="pb-4">
                            <div className="flex items-center justify-between mb-3">
                              <product.icon className="w-6 h-6 text-blue-600" />
                              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                                product.status === 'Future Vision' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                              }`}>
                                {product.status}
                              </span>
                            </div>
                            <CardTitle className="text-md font-bold font-brand-primary mb-2 text-blue-600" dangerouslySetInnerHTML={{ __html: product.name }}>
                            </CardTitle>
                            <CardDescription className="text-gray-600 font-poppins text-xs leading-relaxed">
                              {product.description}
                            </CardDescription>
                          </CardHeader>
                          <CardContent>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold font-brand-primary text-brand-dark-gray mb-4">
                  Our Approach: RAG-First, Results-Driven
                </h2>
                <p className="text-xl text-brand-light-gray max-w-3xl mx-auto font-poppins">
                  We're not just building AI products—we're proving our technology works with real MVPs before expanding our vision.
                </p>
              </div>
                ...
                {values.map((value, index) => (
                  <Card key={index} className="border-0 shadow-lg bg-white hover:shadow-xl transition-all duration-300">
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className={`text-xl font-bold font-brand-primary ${value.color}`}>
                        {value.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 text-center">
                <h3 className="text-2xl font-bold text-brand-purple mb-4 font-brand-primary">
                  Technology Foundation
                </h3>
                <p className="text-lg text-gray-600 font-poppins leading-relaxed mb-6 max-w-3xl mx-auto">
                  Our team combines deep AI expertise with practical development experience. Every solution is built on proven retrieval-augmented generation (RAG) architecture, ensuring responses are contextual, accurate, and source-backed.
                </p>
                <div className="grid md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                  {[
                    ...
                    <div key={index} className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                      <tech.icon className="w-8 h-8 text-brand-purple mb-2" />
        ...
        {/* Call to Action */}
        <section className="py-20 bg-gradient-to-br from-brand-purple to-brand-green">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              <h2 className="text-4xl font-bold font-brand-primary mb-6">
                Ready to Experience AI That Actually Works?
              </h2>
              <p className="text-xl font-poppins leading-relaxed mb-8 max-w-3xl mx-auto">
                Try our proven MVP products and see how RAG-powered AI can transform your learning and career journey.
              </p>
      ...
      <footer className="py-8 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="mb-4">
              <h3 className="text-2xl font-bold font-brand-primary">
                KDx<sup className="text-lg text-yellow-300">AI</sup>
              </h3>
              <p className="text-gray-400 font-poppins">Tasks Digitised. Knowledge Amplified.</p>
            </div>
            <div className="text-sm text-gray-400">
              <p>&copy; 2024 KDxAI. Based in Chennai, India. Building the future of AI-powered solutions.</p>
            </div>
          </div>
        </div>
      </footer>
